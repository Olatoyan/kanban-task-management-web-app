...
function ToggleTheme() {
  return (
    <div className="mt-auto flex flex-col gap-7">
      ...
      <button className="flex items-center gap-4 rounded-[0_10rem_10rem_0] px-[3.2rem] py-[1.4rem] text-[1.5rem] font-bold text-[#828fa3] transition-all duration-300 hover:bg-white hover:text-[#635fc7]">
        <BsEyeSlash />
        <p>Hide Sidebar</p>
      </button>
    </div>
