  ...
  return (
    <div className="mt-auto flex flex-col gap-7">
      ...
      >
        <BsSun />
        <div
          className={`relative h-[2rem] w-[4rem] rounded-full bg-[#635fc7] before:absolute before:top-[11%] before:h-[1.5rem] before:w-[1.5rem] before:rounded-full before:bg-white before:transition-all before:duration-300 group-hover:bg-[#9694d6] ${isDarkMode ? "before:translate-x-[0.4rem]" : "before:translate-x-[2rem]"}`}
        ></div>
        <BsMoonStarsFill />
      </div>
