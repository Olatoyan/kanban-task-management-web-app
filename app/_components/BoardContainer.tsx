...
function BoardContainer({ data }: { data: BoardType[] }) {
  ...
  return (
    <section
      className={`custom-scrollbar h-[86.8vh] overflow-hidden p-[2.4rem] ${isSidebarHidden ? "w-screen" : "w-[80vw]"}`}
    >
      {data.length > 0 ? (
        <div className="custom-scrollbar flex h-full gap-10 overflow-auto">
          <div className="flex gap-10">
            ...
            <div
              className={`group flex w-[28rem] cursor-pointer items-center justify-center ${isDarkMode ? "bg-[linear-gradient(180deg,_rgba(43,44,55,0.25)_0%,_rgba(43,44,55,0.13)_100%)]" : "bg-[linear-gradient(180deg,_#E9EFFA_0%,_rgba(233,239,250,0.50)_100%)]"} `}
